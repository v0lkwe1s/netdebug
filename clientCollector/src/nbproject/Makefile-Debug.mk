...
${OBJECTDIR}/modules/vpn/Group.o: modules/vpn/Group.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Werror -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/modules/vpn/Group.o modules/vpn/Group.cpp

${OBJECTDIR}/modules/vpn/Users.o: modules/vpn/Users.cpp 
	${MKDIR} -p ${OBJECTDIR}/modules/vpn
	${RM} "$@.d"
	$(COMPILE.cc) -g -Werror -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/modules/vpn/Users.o modules/vpn/Users.cpp
